...
session_start();
$name_customer_ = $_GET['name_customer_'];
$_SESSION['location_name_customer'] = $name_customer_;
...
if ($_SESSION['my_role'] === 'ispolnitel'){
  $query = "UPDATE person SET user_role = 'ispolnitel' WHERE name_person ='".$_SESSION["location_name_customer"]."'";
  mysqli_query($conn, $query);
}
elseif ($_SESSION['my_role'] === 'zakazchik'){
  $query = "UPDATE person SET user_role = 'zakazchik' WHERE name_person ='".$_SESSION["location_name_customer"]."'";
  mysqli_query($conn, $query);
}
...
$mysql = mysqli_query($conn, "SELECT * FROM person WHERE name_person ='".$_SESSION["location_name_customer"]."'");
if(mysqli_num_rows($mysql) > 0) {
    $a = mysqli_fetch_array($mysql);
    $_SESSION["online"] = $a["online"];
    $_SESSION["user_role"] = $a["user_role"];
    $query = "UPDATE person SET online='offline' WHERE name_person ='".$_SESSION["location_name_customer"]."'";
    mysqli_query($conn, $query);
